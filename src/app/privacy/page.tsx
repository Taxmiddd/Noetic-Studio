        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="heading-display text-4xl md:text-5xl lg:text-7xl mb-6 tracking-tighter">
              Data <span className="gradient-text">Policy</span>
            </h1>
            <p className="text-body text-lg max-w-2xl">
              Our strict internal protocols detailing how NOÉTIC Studio interacts with, processes, and protects your organizational intelligence and telemetry.
            </p>
          ...
          >
             <p className="text-xs text-[var(--text-bone-dim)] font-[family-name:var(--font-body)] uppercase tracking-widest max-w-xl mx-auto">
                Direct all privacy inquiries or data erasure requests directly to our primary operational channels.
             </p>
          </motion.div>
        </div>
      </section>
